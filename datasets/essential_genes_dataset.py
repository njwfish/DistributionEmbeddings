...
class EssentialGenesDataset(Dataset):
    ...
    def __init__(
        self,
        adata_path: str = "data/essential_genes/essential_gene_knockouts_raw.h5ad",
        ...
        for cell_type in self.cell_types:
            ...
            for perturbation in self.perturbation_types:
                ...
                if len(indices) > 0:
                    eval_set = (perturbation in heldout_perts or cell_type in heldout_cell_types) if self.split_mode == "ood" \
